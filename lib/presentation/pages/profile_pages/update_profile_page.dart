...
import 'package:ayotani/common/styles/button_style.dart';
...
import 'package:ayotani/domain/entities/entities.dart';
import 'package:ayotani/presentation/providers/providers.dart';
  ...
  FormBuilderTextField _buildWeightField() {
    return FormBuilderTextField(
      ...
      decoration: const InputDecoration(
        ...
        hintText: 'contoh format: 6281xxx',
        hintStyle: TextStyle(color: secondaryTextColor),
